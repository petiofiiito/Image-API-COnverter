...
namespace QuadrilateralDistortion
{
    ...
    {
        //Class for image distortion by using 4 points with X ,Y coordinates 
        //The algorithm is slow but works with an easy implemenation
        //e.g  Bitmap bmp = QuadDistort.Distort(transitionBmp, topLeft, topRight, bottomLeft, bottomRight);
